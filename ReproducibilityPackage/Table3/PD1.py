...
print(WP_df)
PD1_Implication = pd.read_csv('Other/PD1_Implication.csv', sep=',')
WP_df["DeepInfer_Implication"] = PD1_Implication
WP_df['DeepInfer_Implication'] = WP_df['DeepInfer_Implication'].replace({'Uncertain':'Wrong'})
print(WP_df["DeepInfer_Implication"])

actual =pd.read_csv('Other/PD1_actual.csv', sep=',')
WP_df['Actual_Outcome'] = actual
print(WP_df['Actual_Outcome'])
prediction =pd.read_csv('Other/PD1_prediction.csv', sep=',')
WP_df['Predicted_Outcome'] = prediction
print(WP_df['Predicted_Outcome'])
