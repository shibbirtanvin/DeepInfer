...
y = df.iloc[:, :1]
WP_df = df
Implication = pd.read_csv('Other/HP2_Implication.csv', sep=',')
...
actual =pd.read_csv('Other/HP2_actual.csv', sep=',')
WP_df['Actual_Outcome'] = actual
print(WP_df['Actual_Outcome'])
prediction =pd.read_csv('Other/HP2_prediction.csv', sep=',')
