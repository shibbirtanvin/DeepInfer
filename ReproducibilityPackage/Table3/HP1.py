...
Implication = pd.read_csv('Other/HP1_Implication.csv', sep=',')
...
actual =pd.read_csv('Other/HP1_actual.csv', sep=',')
WP_df['Actual_Outcome'] = actual
print(WP_df['Actual_Outcome'])

prediction =pd.read_csv('Other/HP1_prediction.csv', sep=',')
