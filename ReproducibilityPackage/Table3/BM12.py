...
predictionvalue =pd.read_csv('Other/bankcustomer_predictionsBM12.csv', sep=',')
...
Implication = pd.read_csv('Other/BM12_Implication.csv', sep=',')
...
WP_df["TrueNegative"] = WP_df.apply(lambda x: "TN" if (x['GroundTruth'] == 'Wrong' and x['DeepInfer_Implication'] == 'Wrong' or x['DeepInfer_Implication'] == 'Uncertain') else "Not", axis=1)
WP_df["FalseNegative"] = WP_df.apply(lambda x: "FN" if (x['GroundTruth'] == 'Correct' and x['DeepInfer_Implication'] == 'Wrong' or x['DeepInfer_Implication'] == 'Uncertain') else "Not", axis=1)
