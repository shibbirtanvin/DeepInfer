...
rslt_df = df
print(df)
#Bank Customer and German Credit
actual =pd.read_csv('Other/german_Actual_df.csv', sep=',')
predictionvalue =pd.read_csv('Other/german_predictionsGC7.csv', sep=',')
print(actual)
X= df
y =actual
...
print(WP_df)
Implication = pd.read_csv('Other/GC7_Implication.csv', sep=',')
